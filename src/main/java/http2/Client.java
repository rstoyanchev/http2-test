...
public class Client
{
    public static void main(String[] args) throws Exception
    {
		...
		try {
			...
			MetaData.Request metaData = new MetaData.Request("GET", new HttpURI("https://" + host + ":" + port + "/home"), HttpVersion.HTTP_2, requestFields);
			...
			session.newStream(headersFrame, new Promise.Adapter<Stream>(), new Stream.Listener.Adapter()
			{
				...
				{
					System.err.println("RECEIVED HEADERS:\n" + frame.getMetaData());
